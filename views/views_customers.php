...
if(isset($_GET["delete"])){
	...
	$delete="DELETE FROM customers WHERE Cust_id='$user_id'";
	try {
	...
	<?php
		...
		<form action="" method="POST">
			<div class="w3-container " id="print_sel">
				...
				<?php echo $notice;?>
				<div class="w3-container w3-white" ><h1><strong>ALL CUSTOMERS </strong></h1></div>
					...
					<tr class="w3-red ">
						...
						<th>ACTION</th>
								...
								<?php
										...
										$SEARCH=$connection->prepare("SELECT * FROM Customers limit $pageno,$rowperpage");
										$SEARCH->execute();
										
										 foreach ($SEARCH->fetchAll() as $row) {?>
										 			
										 			 <tr class='item'>
										 			 <td class='w3-red'><?php echo $row["Cust_id"];?></td>
													 ...
													 <td>
													 	<?php echo "<a title='Click to Delete this User. ' href='views_customers.php?Cust_id=".$row['Cust_id']."&delete' class='w3-btn w3-round-xxlarge w3-red w3-pointer'><i class='fa fa-remove'></i></a>"; ?>
													 </td>
										 			  </tr>
