...
?>
<form action="selling_form.php?item_id=<?=$row['Item_id']?>" method="post" class=" w3-col s12 l3 m4 "
                ...
                if(!empty($_SESSION['cart'])){// if carting is not empty then loop
                     foreach ($_SESSION['cart'] as $data => $value) {
                        ...
                        if (isset($_POST["buy"])) {// inserting carting data in the database
                         $query="INSERT INTO `purchased`( `Item_id`,`Item_type`, `Item_cost`, `Owner_Email`,`Owner_Telephone`, `Buyer_id`, `Buyer_names`, `Buyer_E_mail`, `Buyer_Telephone`, `payment_type`, `Buy_date`, `Item_photo`)
                                VALUES('".$_SESSION["item_item"]."','".$_SESSION["item_type"]."','".$_SESSION["item_cost"]."','".$_SESSION["Owner_E_mail"]."','".$_SESSION["owner_telephone"]."','".$_SESSION["Buyer_id"]."','".$_SESSION["Buyer_name"]."','".$_SESSION["Buyer_E_mail"]."','".$_SESSION["Buyer_Telephone"]."','MTN',Now(),'".$_SESSION["Item_photo"]."')";
                        ...
                        $output.="
                            <tr>
                                ...
                                <td>
                                    <a href='selling_form.php?action=remove&item_id=".$value['item_id']."' class='w3-btn w3-red w3-pointer w3-margin'>Remove</a>
                                </td>
                            </tr>";
                     ...
                     $output.="
                            <tr >
                                ...
                                <td class='w3-light-blue'>
                                    <a href='selling_form.php?action=clearAll' class='w3-btn w3-margin w3-red w3-pointer'>
                                         Clear All
                                    </a>
                                    <form method='POST'>
