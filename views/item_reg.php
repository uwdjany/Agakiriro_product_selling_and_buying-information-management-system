...
include"../controller/logout.php";
 include "../controller/item_reg_ctr.php";?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="w3-container  w3-padding w3-padding-16 w3-center" style="margin-top: 70px;">
    ...
    <?php //echo $notification1;?>  
            ...
            <div class="w3-card-4 w3-round-xxlarge w3-padding-large w3-margin-top" style="margin-left: 235px;">
             <b><button  style="" class="w3-btn w3-card-4 w3-margin w3-border w3-border-blue w3-round-xxlarge w3-grey w3-hover-green" name="insert"><img src="../images_agakiriro/icons/save_as.ico" class="w3-margin-right">Save</button></b>
            <b><button style="" name="cancel" class="w3-btn w3-card-4 w3-border w3-border-blue w3-margin w3-red w3-round-xxlarge w3-hover-blue" name="search"><img src="../images_agakiriro/icons/Cancel.ico" class="w3-margin-right">Cancel</button></b>
            </div>
            </form>
