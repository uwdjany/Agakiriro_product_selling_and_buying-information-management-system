            ...
            <div class="w3-col l8 m8 s12 w3-card-2  w3-padding-16 w3-container w3-margin w3-round-xxlarge" style="overflow-x:auto;overflow-y:auto;" >
                    ...
                    <div class="w3-col l5 m6 s12">
                     ...
                     <div class="w3-col l5 m6 s12 w3-margin-right">
                        ...
                        <?php if($_SESSION["User_type"]=="Manager" || $_SESSION["User_type"]=="Staff"){?>
                           ...
                           <div class="w3-col  l5 m6 s12 w3-margin-right" style="">
                              ...
                              <div class="w3-margin-right" ><input type="file" accept="image/*" name="photo" onchange="loadfile(event)"  class=" w3-input w3-round-xxlarge w3-border w3-border" style="" ></div>
                            </div> 
                        <?php }
                      else{
                     ...
                     <div class="w3-col l5 m6 s12 w3-margin-right">
                            ...
                            <div class=""><select name="staff_type" class=" w3-input w3-round-xxlarge w3-border w3-border" style="">
                  ...
                  <div class=" w3-col l3 m6 s12 w3-margin-top w3-margin-left w3-padding ">  
                          <div class=" w3-padding">  <img  id="img_photo"  src="<?php echo $photo;?>"  class="w3-border w3-border-blue" style="width:100%; height:auto;" ></div>
                      <?php }
                      else{?>

                            <div class=" w3-col l3 m6 s12 w3-margin-top w3-margin-left w3-padding w3-black w3-card-4 w3-round-xxlarge">  
                          <div class=" w3-padding"> <h2 class="" ><strong style="">Welcome dear Customer You are more valuable to Us. Please Enjoy What is found in this system.</strong></h2> </div>
                     <?php }
                      ?>
